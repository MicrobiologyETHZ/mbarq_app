...
def home_page():
    ...
    ***
    ...
    - Requires a `csv` file generated by [`mbarq map`]({map_url}) command. This files lists the insertion site of each barcode in your mutant library.  
    ...
    ***
    ...
    - Requires a `csv` file produced by `mbarq analyze` command. This file lists log fold changes (LFC) and FDRs for each gene in the library.
