...
def home_page():
    ...
    ***
    ...
    2. ### : Count and sample data files
        ...
        - Visit 📈 **Exploratory Analysis** page for examples
        - 📈 Exploratory Analysis page generates an interactive PCA plot and barcode abundance plots for genes of interest
    ...
    ***
    ...
    3. ### Final results table and annotations file (optional)
        ...
        - 📊 **Differential Abundance** page allows visualisation of LFCs for genes of interest
