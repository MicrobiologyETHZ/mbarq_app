...
def home_page():
    ...
    Transposon mutagenesis is a powerful technique that allows the identification of bacterial fitness factors under 
   ...
   libraries for any transposon construct. To learn more about the analysis of barcoded sequencing data using mBARq, please read the [documentation]({docs_url}). This app allows the exploration of data analyzed with the [mBARq tool](
   {repo_url}). 
    ...
    Below is a quick summary of each of the pages, visit each of the pages to browse the example data set. 
